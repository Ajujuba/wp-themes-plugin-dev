...
// PRATICE 4 - Remove unwanted columns from post listing
function wphooks_customize_post_columns( $columns ) {

  // unset( $columns['author'] );
  // unset( $columns['categories'] );
  unset( $columns['tags'] ); // unset will remove this column from the array so it will not be shown
