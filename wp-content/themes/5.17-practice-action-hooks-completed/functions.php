...
function wphooks_draft_mode_styles() {
  ...
  if( 'draft' === $post->post_status ) {
    var_dump('load css to change the background if is a draft'); //this run in all my admin area i think
    //Load css to change editor layout when the post is a draft
